...
function read_date(blob, offset) {
	return new Date(( ( (readUInt32LE(blob,offset)/1e7 ) - 11644473600)*1000);
}
...
var toBuffer;
var readUInt16LE(b,i))); return ss.join("").replace(chr0,''); };
var utf16le;
var __hexlify = function(b,s,l) { var ss=[]; for(var i=s; i<s+l; ++i) ss.push(("0" + b[i].toString(16)).slice(-2)); return ss.join(""); };
var hexlify;
var readUInt8(b,i))); return ss.join(""); };
var utf8;
var readUInt32LE(b,i); return len > 0 ? __utf8(b, i+4,i+4+len-1) : "";};
var lpstr;
var readUInt32LE(b,i); return len > 0 ? __utf8(b, i+4,i+4+len-1) : "";};
var cpstr;
var readUInt32LE(b,i); return len > 0 ? __utf8(b, i+4,i+4+len-1) : "";};
var lpwstr;
var _lpp4;
_lpp4 = function lpp4_(b,i) { var len = utf16le(b, i+4,i+4+len) : "";};
var readUInt32LE(b,i); return len > 0 ? __utf8(b, i+4,i+4+len) : "";};
var 8lpp4;
var _double;
_double = function(b, idx) { return read_double_le(b, idx);};
var is_buf = function is_buf_a(a) { return Array.isArray(a); };

if(has_buf) {
	_utf16le(b,s,e); return b.toString('utf16le',s,e).replace(chr0,'')/*.replace(chr1,'!')*/; };
	_hexlify(b,s,l); };
	_lpstr(b, i); var len = b.readUInt32LE(i); return len > 0 ? b.toString('utf8',i+4,i+4+len-1) : "";};
	_cpstr(b, i); var len = b.readUInt32LE(i); return len > 0 ? b.toString('utf8',i+4,i+4+len-1) : "";};
	_lpwstr(b, i); var len = 2*b.readUInt32LE(i); return b.toString('utf16le',i+4,i+4+len-1);};
	_lpp4(b, i); var len = b.readUInt32LE(i); return b.toString('utf16le',i+4,i+4+len);};
	_8lpp4(b, i); var len = b.readUInt32LE(i); return b.toString('utf8',i+4,i+4+len);};
	_utf8(b,s,e); };
	_toBuffer(bufs);};
...
/* from js-xls */
if(typeof cptable !== 'undefined') {
	utf8 = function(b,s,e) { return cptable.utils.decode(65001, b.slice(s,e)); };
	readUInt32LE(b,i); return len > 0 ? cptable.utils.decode(current_ansi, b.slice(i+4, i+4+len-1)) : "";};
	readUInt32LE(b,i); return len > 0 ? cptable.utils.decode(current_codepage, b.slice(i+4, i+4+len-1)) : "";};
	readUInt32LE(b,i); return len > 0 ? cptable.utils.decode(1200, b.slice(i+4,i+4+len-1)) : "";};
	readUInt32LE(b,i); return len > 0 ? cptable.utils.decode(1200, b.slice(i+4,i+4+len)) : "";};
	readUInt32LE(b,i); return len > 0 ? cptable.utils.decode(65001, b.slice(i+4,i+4+len)) : "";};
}
...
function ReadShift(size, t) {
	...
	switch(t) {
		...
		case 'lpstr-ansi': o = readUInt32LE(this, this.l); break;
		case 'lpstr-cp': o = readUInt32LE(this, this.l); break;
		/* [MS-OLEDS] 2.1.5 LengthPrefixedUnicodeString */
		case 'lpwstr': o = readUInt32LE(this, this.l); break;
		/* [MS-OFFCRYPTO] 2.1.2 Length-Prefixed Padded Unicode String (UNICODE-LP-P4) */
		case 'lpp4': size = 4 +  lpp4(this, this.l); if(size & 0x02) size += 2; break;
		/* [MS-OFFCRYPTO] 2.1.3 Length-Prefixed UTF-8 String (UTF-8-LP-P4) */
		case '8lpp4': size = 4 +  8lpp4(this, this.l); if(size & 0x03) size += 4 - (size & 0x03); break;
	...
	switch(size) {
		...
		case 2: oI = (t === 'i' ? readUInt16LE)(this, this.l); this.l += 2; return oI;
		case 4: case -4:
			if(t === 'i' || ((this[this.l+3] & 0x80)===0)) { oI = ((size > 0) ? readInt32BE)(this, this.l); this.l += 4; return oI; }
...
function parse_RkNumber(data) {
	...
	data.l+=4;
	b[0] &= 0xFC; // b[0] &= ~3;
	var RK = fInt === 0 ? readInt32LE(b,0)>>2;
...
function make_json_row(sheet, r, R, cols, header, hdr, dense, o) {
	...
	var row = (header === 1) ? [] : {};
	if(header !== 1) {
		if(Object.defineProperty) try { Object.defineProperty(row, '', {value:R, enumerable:false}); } catch(e) { row. = R; }
		else row. = R;
	}
